...
class QuickPushDataStructureTest {
    ...
    @Test
    void testString() {
        QuickDataStructure<String> structureString = new QuickPushDataStructure<>();
    ...
    void testStringOverrideComparator() {
        QuickDataStructure<String> structureString = new QuickPushDataStructure<>(new Comparator<String>() {
            @Override
    ...
    @Test
    void testPerson() {
        QuickDataStructure<Person> structurePerson = new QuickPushDataStructure<>(Comparator.comparing(Person::getBirth));
    ...
    void testNotComparable() {
        QuickDataStructure<Person> structurePerson = new QuickPushDataStructure<>();
